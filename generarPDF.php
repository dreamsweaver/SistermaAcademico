...
#header td:first {padding-left:55px;}
.page-number {text-align: center;}
.page-number:before {content: "pagina " counter(page);}
...
<div id="header">
  <table class="invisible">
    <tr>
      <td><img src="template/imagenes/logo.png" style="vertical-align:middle; width:50px; position:fixed; left:0%; top:-40px; padding-right:40px; opacity:0.5;" />Colegio Cristiano Emanuel</td>
      <td style="text-align: right;">Luis Anaya</td>
    </tr>
  </table>
</div>
...
$nombreDelPDF = 'mipdf';
//incluimos el archivo base para la creacion del objeto DOMPDF
require_once "dompdf/dompdf_config.inc.php";
//Creamos el objeto dompdf
$dompdf = new DOMPDF();
//cargamos el codigo html
$dompdf->load_html($html);
//agregamos las configuraciones del papel
$dompdf->set_paper("letter", "portrait");
//renderizamos el pdf en base al html y los set de papel
$dompdf->render();
//mostramos el pdf generado, leagregamos un nombre
$dompdf->stream($nombreDelPDF.".pdf", array("Attachment" => false));
//lo exportamos de ser necesario
//$pdf = $dompdf->output();
//Lo guardamos en el servidor
//file_put_contents("pdfs/".$nombreDelPDF."_".date('dmY').".pdf", $pdf);